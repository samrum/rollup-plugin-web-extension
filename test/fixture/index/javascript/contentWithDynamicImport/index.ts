export const inputManifest = {
  content_scripts: [
    {
      js: ["test/fixture/index/javascript/contentWithDynamicImport/content1.js"],
      matches: ["https://*/*", "http://*/*"],
    },
    {
      js: ["test/fixture/index/javascript/contentWithDynamicImport/content2.js"],
      matches: ["https://*/*", "http://*/*"],
    },
  ],
};
...
export const expectedManifest = {
  content_scripts: [
    {
      js: ["loader/test/fixture/index/javascript/contentWithDynamicImport/content1.js"],
      matches: ["https://*/*", "http://*/*"],
    },
    {
      js: ["loader/test/fixture/index/javascript/contentWithDynamicImport/content2.js"],
      matches: ["https://*/*", "http://*/*"],
    },
  ],
